...
@implementation LocationPickerAdvancedSettingsListViewController
/*
- (id)specifiers {
    if(_specifiers == nil) {
...
-(id)tableView:(UITableView *)arg1 cellForRowAtIndexPath:(id)arg2 {
    ...
    return [UITableViewCell new];//[self tableView:arg1 cellForRowAtIndexPath:arg2];
}
...
- (id)readPreferenceValue:(PSSpecifier *)specifier {
    ...
    LocationPickerViewController *parent = (LocationPickerViewController *)self.parentViewController;
