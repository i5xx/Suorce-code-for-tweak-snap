//
//  LocationPickerAdvancedSettingsView.m
//  ShadowUI
//
...
@implementation LocationPickerAdvancedSettingsView
...
-(id)initWithFrame:(CGRect)frame controller:(UIViewController*)controller {
    ...
    [self.chevronButton setImage:[[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/RelocatePrefs.bundle/idk.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
...
/*
    self.listController = [[LocationPickerAdvancedSettingsListViewController alloc] init];
...
-(void)setProgress:(CGFloat)progress {
    LocationPickerView *parent = (LocationPickerView *)self.superview;
